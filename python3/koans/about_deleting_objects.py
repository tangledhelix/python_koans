...
class AboutDeletingObjects(Koan):
    def test_del_can_remove_slices(self):
        ...
        del lottery_nums[1] # now [4, 15, 16, 23, 42]
        del lottery_nums[2:4] # now [4, 15, 42]
    ...
    def test_del_can_remove_attributes(self):
        ...
        self.assertRegexpMatches(err_msg1, "object has no attribute 'toilet_brushes'")
        self.assertRegexpMatches(err_msg2, "object has no attribute 'hamsters'")
